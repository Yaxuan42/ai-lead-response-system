const translations = {
  zh: {
    ...
    htmlLang: "zh-CN",
    eyebrow: "餐饮 / 茶饮招商加盟",
    headline: "60 秒内接住每条加盟咨询。",
    "hero.copy": "我帮连锁餐饮和茶饮品牌把官网招商表单、抖音私信和企微咨询接入自动回复、意向评级、招商顾问提醒和跟进队列。",
    "hero.primaryCta": "预约 15 分钟诊断",
    "hero.secondaryCta": "查看招商演示",
    "hero.proof1": "7 天内跑通招商试点",
    "hero.proof2": "先提升跟进，不重做官网",
    "hero.proof3": "适合多门店扩张品牌",
    "offer.kicker": "首单试点",
    "offer.price": "¥6,800 起搭建",
    "offer.body": "交付一个真实可用的招商线索响应流程，包含入口接入、意向评级、招商顾问提醒和跟进表。",
    ...
    "metric.action": "下一步动作",
    "value.1.kicker": "不丢线索",
    "value.1.title": "加盟咨询先被接住",
    "value.1.body": "候选人刚留资时最热，系统先回复，再提醒招商顾问跟进。",
    "value.2.kicker": "快筛选",
    "value.2.title": "高意向加盟商排到前面",
    "value.2.body": "预算、城市、铺位、经验和开店时间会被提取，顾问先跟进最可能成交的人。",
    "value.3.kicker": "可落地",
    "value.3.title": "先跑通招商 SOP",
    "value.3.body": "第一版接入现有表单、企微和表格，跑出数据后再升级 CRM。",
    "form.title": "招商新咨询",
    "form.sample": "换个样例",
    "form.name": "咨询人姓名",
    "form.contact": "联系方式",
    ...
    "package.growth.title": "¥15,000 起",
    "package.growth.1": "官网 / 抖音 / 企微线索汇总",
    "package.growth.2": "加盟政策 FAQ 知识库",
    "package.growth.3": "顾问分配和跟进阶段",
    "package.growth.4": "招商漏斗 7 天复盘",
    "package.care.kicker": "持续优化",
    "package.care.title": "¥1,500 / 月起",
    "package.care.1": "招商话术更新",
    "package.care.2": "线索分层规则调优",
    "package.care.3": "每月招商漏斗报告",
    "package.care.4": "新增入口小改动支持",
    "contact.kicker": "下一步",
    "contact.title": "发一个招商入口，我判断能不能 7 天内跑通试点。",
    "contact.body": "适合正在扩张的连锁餐饮、茶饮、咖啡、烘焙和小吃品牌。先把留资、评级、分配和跟进跑通。",
    ...
    contactDefaults: {
      ...
      leadSource: "官网招商页 / 抖音私信 / 企微",
      businessGoal: "加盟咨询分散，高预算、有铺位的候选人没有被优先跟进。",
    },
  ...
  en: {
    title: "AI Franchise Lead Response System",
    htmlLang: "en",
    eyebrow: "Restaurant / tea franchise recruitment",
    headline: "Capture every franchise inquiry in under 60 seconds.",
    "hero.copy": "I help restaurant and tea chains connect franchise forms, social messages, and WeCom inquiries to auto replies, intent scoring, franchise consultant alerts, and a follow-up queue.",
    "hero.primaryCta": "Book a 15-minute audit",
    "hero.secondaryCta": "See the franchise demo",
    "hero.proof1": "Pilot live in 7 days",
    "hero.proof2": "Improve follow-up before rebuilding the site",
    "hero.proof3": "Built for multi-store expansion brands",
    "offer.kicker": "Pilot offer",
    "offer.price": "$950+ setup",
    "offer.body": "A working franchise lead-response workflow with intake, intent scoring, consultant alerts, and a follow-up table.",
    ...
    "value.1.kicker": "No missed leads",
    "value.1.title": "Franchise inquiries get captured",
    "value.1.body": "The system replies while the candidate is still warm, then routes follow-up to the right consultant.",
    ...
    "value.3.title": "Run the franchise SOP first",
    "value.3.body": "The first version connects your current forms, WeCom, and spreadsheets. Upgrade CRM after data proves the flow.",
    ...
    "table.value": "Budget",
    "table.status": "Status",
    "package.quick.kicker": "Franchise pilot",
    ...
    "package.growth.title": "$2,100+",
    "package.growth.1": "Website / social / WeCom intake",
    "package.growth.2": "Franchise FAQ knowledge base",
    "package.growth.3": "Consultant routing and funnel stage",
    "package.growth.4": "7-day franchise funnel review",
    "package.care.kicker": "Optimization",
    "package.care.title": "$220 / mo+",
    "package.care.1": "Franchise script updates",
    "package.care.2": "Lead scoring rule tuning",
    "package.care.3": "Monthly funnel report",
    "package.care.4": "Small intake-source updates",
    "contact.kicker": "Next step",
    "contact.title": "Send one franchise intake source. I will tell you whether a 7-day pilot is realistic.",
    "contact.body": "Best for growing restaurant, tea, coffee, bakery, and snack chains. Start by making intake, scoring, routing, and follow-up work.",
    "contact.business": "Brand type",
    "contact.entry": "Franchise intake source",
    ...
    contactDefaults: {
      ...
      leadSource: "Franchise page / social DMs / WeCom",
      businessGoal: "Franchise inquiries are scattered, and high-budget candidates with sites are not prioritized.",
    },
    contactEmailBody: (businessType, leadSource, businessGoal) =>
